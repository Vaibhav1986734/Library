<?php
     ...
     if (session_status() == PHP_SESSION_NONE) 
      ...
      if(isset($_SESSION["rolename"]) && isset($_SESSION["logstatus"]) && $_SESSION["rolename"]=="H.O.D.")
      {
                    ...
                    <div class="row">
                            <div class="col-md-4">
                                <div class="profile-img">
                                    <img src="<?php echo $photo ?>" alt="avatar"  class="img-thumbnail mb-2 " style="width: 60%; border-radius:20%; ">
                                </div>
                            </div>
